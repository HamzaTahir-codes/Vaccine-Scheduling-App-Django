...
class CreateVaccine(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "Vaccine Creation Successfull!")
            return HttpResponseRedirect(reverse("vaccine:list"))
        messages.error(request, "Vaccine Creation Failed!")
...
class UpdateVaccine(View):
    ...
    def post(self, request, id):
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "Vaccine Updation Successfull!")
            return HttpResponseRedirect(reverse("vaccine:detail", kwargs={"id": vaccine.id}))
        messages.error(request, "Vaccine Updation Failed!")
        return render(request, self.template_name, {"form": form})
...
class DeleteVaccine(View):
    ...
    def post(self, request, id):
        ...
        messages.success(request, "Vaccine Deletion Successfull!")
        return HttpResponseRedirect(reverse("vaccine:list"))
